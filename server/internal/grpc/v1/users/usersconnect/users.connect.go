...
var (
	userServiceServiceDescriptor   = __.File_v1_users_users_proto.Services().ByName("UserService")
...
type UserServiceClient interface {
	Get(context.Context, *connect.Request[__.GetUserRequest]) (*connect.Response[__.GetUserResponse], error)
}
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		get: connect.NewClient[__.GetUserRequest, __.GetUserResponse](
			httpClient,
...
type userServiceClient struct {
	get *connect.Client[__.GetUserRequest, __.GetUserResponse]
}

// Get calls users.v1.UserService.Get.
func (c *userServiceClient) Get(ctx context.Context, req *connect.Request[__.GetUserRequest]) (*connect.Response[__.GetUserResponse], error) {
...
func (UnimplementedUserServiceHandler) Get(context.Context, *connect.Request[__.GetUserRequest]) (*connect.Response[__.GetUserResponse], error) {
