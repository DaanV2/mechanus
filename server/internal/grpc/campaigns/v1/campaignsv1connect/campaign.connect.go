...
import (
	...
	v1 "github.com/DaanV2/mechanus/server/internal/grpc/campaigns/v1"
	http "net/http"
)
...
var (
	campaignServiceServiceDescriptor = v1.File_campaigns_v1_campaign_proto.Services().ByName("CampaignService")
)
