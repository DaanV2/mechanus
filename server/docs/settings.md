...
| web_static_folder | string |                                | ../client/build |     |
...
| maxopenconns    | int      | Sets the maximum number of open connections to the persistence. If n <= 0, then there is no limit on the number of open connections. | 0         | DATABASE_MAXOPENCONNS    |
